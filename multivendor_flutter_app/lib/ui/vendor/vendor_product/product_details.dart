...
class VendorProductDetail extends StatefulWidget {
  ...
  const VendorProductDetail({super.key, required this.productId});
...
class _VendorProductDetailState extends State<VendorProductDetail>
                ...
                onSelected: (value) async {
                  if (value == 'edit') {
                    final updated = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => VendorProductForm(product: _product),
                      ),
                    );
  ...
  Future<void> _openForm() async {
    final updated = await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => VendorProductForm(product: _product)),
    );
    if (updated == true) _loadProduct();
  }
